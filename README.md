...
| Platform | Package |
|----------|---------|
| [Any Linux (x86_64)](#appimage) | `TaskCoach-2.0.2.25-x86_64.AppImage` |
| [Arch Linux / Manjaro](#arch-linux--manjaro) | `taskcoach-2.0.2.25-arch.pkg.tar.zst` |
| [Debian 12 (Bookworm)](#debian--ubuntu) | `taskcoach_2.0.2.25_debian-12-bookworm.deb` |
| [Debian 13 (Trixie)](#debian--ubuntu) | `taskcoach_2.0.2.25_debian-13-trixie.deb` |
| [Debian Sid](#debian--ubuntu) | `taskcoach_2.0.2.25_debian-sid.deb` |
| [Fedora 42/43](#fedora) | `taskcoach-2.0.2.25-fedora43.rpm` |
| [Flatpak (any Linux)](#flatpak) | `TaskCoach-2.0.2.25-x86_64.flatpak` |
| [Linux Mint](#debian--ubuntu) | Use Ubuntu `.deb` (Mint is Ubuntu-based) |
| [macOS (Apple Silicon)](#macos) | `TaskCoach-2.0.2.25-macos-arm64.dmg` |
| [macOS (Intel)](#macos) | `TaskCoach-2.0.2.25-macos-intel.dmg` |
| [Ubuntu 22.04 (Jammy)](#debian--ubuntu) | `taskcoach_2.0.2.25_ubuntu-22.04-jammy.deb` |
| [Ubuntu 24.04 (Noble)](#debian--ubuntu) | `taskcoach_2.0.2.25_ubuntu-24.04-noble.deb` |
| [Windows](#windows) | `TaskCoach-2.0.2.25-windows-x64-setup.exe` |
| [Windows (portable)](#windows) | `TaskCoach-2.0.2.25-windows-x64-portable.zip` |
...
```bash
cd ~/Downloads
wget https://github.com/taskcoach/taskcoach/releases/latest/download/taskcoach_2.0.2.25_debian-13-trixie.deb
sudo apt install ./taskcoach_2.0.2.25_debian-13-trixie.deb
```
...
```bash
cd ~/Downloads
wget https://github.com/taskcoach/taskcoach/releases/latest/download/taskcoach-2.0.2.25-arch.pkg.tar.zst
sudo pacman -U taskcoach-2.0.2.25-arch.pkg.tar.zst
```
...
```bash
cd ~/Downloads
wget https://github.com/taskcoach/taskcoach/releases/latest/download/taskcoach-2.0.2.25-fedora43.rpm
sudo dnf install ./taskcoach-2.0.2.25-fedora43.rpm
```
...
```bash
cd ~/Downloads
wget https://github.com/taskcoach/taskcoach/releases/latest/download/TaskCoach-2.0.2.25-x86_64.AppImage
chmod +x TaskCoach-2.0.2.25-x86_64.AppImage
```

To launch the AppImage, open the file or run:
```
./TaskCoach-2.0.2.25-x86_64.AppImage
```
...
```bash
cd ~/Downloads
wget https://github.com/taskcoach/taskcoach/releases/latest/download/TaskCoach-2.0.2.25-x86_64.flatpak
flatpak install ./TaskCoach-2.0.2.25-x86_64.flatpak
