# Python 3 Migration Technical Notes - Part 1: Core wxPython Issues
...
**Contents:**
- [Widget Resizing Issues](#widget-resizing-issues)
- [wx.Timer Crash During Window Destruction](#wxtimer-crash-during-window-destruction)
- [Ctrl+C Crash with AUI Event Handler Assertion](#ctrlc-crash-with-aui-event-handler-assertion)
- [wxPython Compatibility](#wxpython-compatibility)
...
**Next:** [Part 2: Library Cleanup and Framework Removal](PYTHON3_MIGRATION_2.md)
