...
| `monkeypatches.py` | `wx.Timer` owner guard | Stops timers still running when their owner window is destroyed, logs the start stack | Required, see [CRASH_GUARD.md](CRASH_GUARD.md) |
